...
\begin{itemize}
    ...
    \item \textbf{Hallucination Rate}: 2.1\% (with knowledge graph + prevention system)
...
\begin{itemize}
    ...
    \item \textbf{2.1\% hallucination rate} (down from 12\%) with knowledge graph + prevention system
