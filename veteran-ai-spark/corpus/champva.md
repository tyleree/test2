...
[Skip to Content](https://www.veteransbenefitskb.com/champva#page)
...
![Icon of a checklist document with checkmarks, surrounded by a blue circle, and the text "CHAMPVA" underneath.](https://images.squarespace-cdn.com/content/v1/66c515a3e8305f0f79e8b680/c4313d89-39b4-4504-ba54-ae19303b3ee8/champva.png)
...
[Featured Articles](https://www.veteransbenefitskb.com/champva)
...
[Categories](https://www.veteransbenefitskb.com/champva)
...
[Return to top](https://www.veteransbenefitskb.com/champva#top)
...
- #### How long will it take for me to get a response after applying?
...
- #### I need coverage NOW but it is taking forever to get approved for CHAMPVA! What can I do?
...
- #### Can the Veteran get coverage under CHAMPVA?
...
Follow the following [link](https://www.va.gov/COMMUNITYCARE/programs/dependents/champva/CITI-Facilities.asp).
...
- #### Can a dependent parent parent be covered under CHAMPVA?
...
- No. According to [38 CFR § 17.271 - Eligibility](https://www.law.cornell.edu/cfr/text/38/17.271) they are **NOT** eligible (outside of being an appropriate caregiver)


- #### Can CHAMPVA act as primary insurance if I have another insurance?
...
- **NO _UNLESS_** the other insurance is:
...
- #### Can CHAMPVA be secondary (supplemental insurance) if I have another insurance?
...
- **YES _UNLESS_** the other insurance is:
...
- #### If CHAMPVA is secondary how does the billing work?
...
- Your health care provider should bill the other insurance first. The provider should then submit the Explanation of Benefits (EOB) from the other insurance along with the claim for reimbursement to CHAMPVA.


- #### My spouse is pregnant when can we add our new child?
...
- You won’t be able to add them till they have a Social Security Number. Once you get it, be sure to [Claim](https://www.veteransbenefitskb.com/depends) them as a dependent and **THEN** apply to have them added to CHAMPVA.


- #### Since it takes so long for approval what's going to happen to the bills related to my newborn?
...
- Don’t worry! The hospital and billing staff are well aware it is a process to get newborns added to insurance. With most not requiring you to pay immediately.
...
- #### My dependent's application was denied because they are eligible for TRICARE; when they should not be?
...
1. Double check to see if DEERS has you listed as eligible or not.
...
- #### I am a Gray/Grey Area Retiree and I am having issues getting my dependent(s) approved?
