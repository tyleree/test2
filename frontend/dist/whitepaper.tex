...
src/
  rag_pipeline.py      # Main RAG orchestration + 7-layer defense
...
The Veterans Benefits AI RAG system represents a sophisticated yet maintainable architecture that prioritizes accuracy for veterans. The comprehensive 7-layer hallucination prevention system, combined with intelligent model routing and a knowledge graph for entity-aware caching, delivers 98\% citation accuracy while reducing costs by 44\%.
...
\subsection{7-Layer Hallucination Prevention Summary}
...
The zero-token post-processing approach (Layers 3-6) demonstrates that effective hallucination prevention doesn't require expensive LLM calls---careful Python-based verification and cleanup can catch and correct many issues without any additional cost.
